...
(() => {
  ...
  if (
    ...
    function rtlFn() {
        ...
        const cssPath = origin + "/assets/admin/libs/bootstrap/css/bootstrap.rtl.min.css";
        ...
        if (localStorage.getItem('nowartl')) {
            const rtlSwitch = document.querySelector('#switcher-rtl');
            if (rtlSwitch) rtlSwitch.checked = true;
        }
    }
