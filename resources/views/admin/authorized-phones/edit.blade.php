...
@section('title', 'تعديل رقم مصرح به')

@php
    $breadcrumbTitle = 'تعديل رقم مصرح به';
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('phone', $authorizedPhone->phone) }}"
                                           required>
                                    @error('phone')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('name', $authorizedPhone->name) }}">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" 
                                              ...
                                              rows="3"
                                              placeholder="ملاحظات إضافية (اختياري)">{{ old('notes', $authorizedPhone->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               value="1" 
                                               id="is_active"
                                               {{ old('is_active', $authorizedPhone->is_active) ? 'checked' : '' }}>
