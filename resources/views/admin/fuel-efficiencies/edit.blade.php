                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="fuel_efficiency_comparison" 
                                            ...
                                            <option value="within_standard" {{ old('fuel_efficiency_comparison', $fuelEfficiency->fuel_efficiency_comparison) === 'within_standard' ? 'selected' : '' }}>ضمن المعدل</option>
                                            <option value="above" {{ old('fuel_efficiency_comparison', $fuelEfficiency->fuel_efficiency_comparison) === 'above' ? 'selected' : '' }}>أعلى من المعدل</option>
                                            <option value="below" {{ old('fuel_efficiency_comparison', $fuelEfficiency->fuel_efficiency_comparison) === 'below' ? 'selected' : '' }}>أقل من المعدل</option>
                                        </select>
