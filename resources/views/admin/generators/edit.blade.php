            ...
            <div class="col-12">
                <div class="card gen-card">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.generators.update', $generator) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name', $generator->name) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="generator_number" class="form-control @error('generator_number') is-invalid @enderror" 
                                       value="{{ old('generator_number', $generator->generator_number) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    @foreach($constants['status'] ?? [] as $status)
                                        <option value="{{ $status->value }}" {{ old('status', $generator->status) == $status->value ? 'selected' : '' }}>
                                            {{ $status->label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="engine_type" class="form-select @error('engine_type') is-invalid @enderror">
                                    ...
                                    @foreach($constants['engine_type'] ?? [] as $engineType)
                                        <option value="{{ $engineType->value }}" {{ old('engine_type', $generator->engine_type) == $engineType->value ? 'selected' : '' }}>
                                            {{ $engineType->label }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="injection_system" class="form-select @error('injection_system') is-invalid @enderror">
                                    ...
                                    @foreach($constants['injection_system'] ?? [] as $injection)
                                        <option value="{{ $injection->value }}" {{ old('injection_system', $generator->injection_system) == $injection->value ? 'selected' : '' }}>
                                            {{ $injection->label }}
                                        </option>
                                    @endforeach
                                    {{-- Fallback للقيم القديمة --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="measurement_indicator" class="form-select @error('measurement_indicator') is-invalid @enderror">
                                    ...
                                    @foreach($constants['measurement_indicator'] ?? [] as $indicator)
                                        <option value="{{ $indicator->value }}" {{ old('measurement_indicator', $generator->measurement_indicator) == $indicator->value ? 'selected' : '' }}>
                                            {{ $indicator->label }}
                                        </option>
                                    @endforeach
                                    {{-- Fallback للقيم القديمة --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="technical_condition" class="form-select @error('technical_condition') is-invalid @enderror">
                                    ...
                                    @foreach($constants['technical_condition'] ?? [] as $condition)
                                        <option value="{{ $condition->value }}" {{ old('technical_condition', $generator->technical_condition) == $condition->value ? 'selected' : '' }}>
                                            {{ $condition->label }}
                                        </option>
                                    @endforeach
                                    {{-- Fallback للقيم القديمة --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="control_panel_type" class="form-select @error('control_panel_type') is-invalid @enderror">
                                    ...
                                    @foreach($constants['control_panel_type'] ?? [] as $panelType)
                                        <option value="{{ $panelType->value }}" {{ old('control_panel_type', $generator->control_panel_type) == $panelType->value ? 'selected' : '' }}>
                                            {{ $panelType->label }}
                                        </option>
                                    @endforeach
                                    {{-- Fallback للقيم القديمة --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="control_panel_status" class="form-select @error('control_panel_status') is-invalid @enderror">
                                    ...
                                    @foreach($constants['control_panel_status'] ?? [] as $panelStatus)
                                        <option value="{{ $panelStatus->value }}" {{ old('control_panel_status', $generator->control_panel_status) == $panelStatus->value ? 'selected' : '' }}>
                                            {{ $panelStatus->label }}
                                        </option>
                                    @endforeach
                                    {{-- Fallback للقيم القديمة --}}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if($generator->external_fuel_tank && $generator->fuelTanks->count() > 0)
            ...
            @foreach($generator->fuelTanks as $index => $tank)
                document.querySelector(`select[name="fuel_tanks[{{ $index }}][capacity]"]`).value = '{{ $tank->capacity }}';
