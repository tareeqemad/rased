                                        ...
                                        <select name="generator_id" id="generator_id" 
                                            ...
                                            @foreach($generators as $generator)
                                                <option value="{{ $generator->id }}" 
                                                        {{ old('generator_id', $selectedGeneratorId ?? null) == $generator->id ? 'selected' : '' }}>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="work_performed" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="أدخل تفاصيل الأعمال المنفذة...">{{ old('work_performed') }}</textarea>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" step="0.01" name="labor_rate_per_hour" id="labor_rate_per_hour"
                                               ...
                                               value="{{ old('labor_rate_per_hour', 100) }}" 
                                               min="0" 
                                               placeholder="100.00">
