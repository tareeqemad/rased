                            ...
                            <div class="row g-3 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.0001" name="electricity_tariff_price" 
                                           ...
                                           value="{{ old('electricity_tariff_price') }}" 
                                           min="0" 
                                           max="500"
                                           placeholder="0.0000"
    ...
    (function($) {
        $(document).ready(function() {
            ...
            if ($operatorSelect.length) {
                $operatorSelect.on('change', loadTariffPrice);
            }
            if (operationDateInput) {
                operationDateInput.addEventListener('change', loadTariffPrice);
            }
            
            // Load on page load if values exist
            @if(old('operator_id') || old('operation_date'))
                loadTariffPrice();
            @endif
                        ...
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function(field, messages) {
                                ...
                                if ($field.length) {
                                    ...
                                    // إذا كان Select2، نضيف class للـ container أيضاً
